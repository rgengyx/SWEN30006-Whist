...
public class SmartStrategy implements IGameStrategy {
	...
	private Card determineLeadingCard(Player player) {
		// represents the player (not the one invoking this method) with the highest
		// score
	...
	// attempt to find the lowest rank card that isn't the trump suit if possible;
	...
	/*
	 * Will attempt to return a card that ranks higher than the leading card (that
