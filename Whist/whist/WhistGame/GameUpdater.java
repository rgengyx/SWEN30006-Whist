...
public class GameUpdater {
	...
	// notifies players that a card has been played and whether or not this card is the best card in the trick
	...
	// trump suits do not remain consistent, there is a chance that no winners have been set even if hands are depleted
	...
	/* all history is removed because a deck of cards can be redistributed again if no winners are settled, that is,
	 * we don't want players to assume that previous cards are still present */
